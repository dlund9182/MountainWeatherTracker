...
class yr(weatherModel.weatherModel):
    ...
    def getTemp(self):
        ...
        Array = self._getArray(1,40,self._soup,"temp")
    ...
    def getPrecipitation(self):
        ...
        self._attr = {"class":"Precipitation-module__main-sU6qN"}

        Array = self._getArray(0,34,self._soup,"precip")
...
def main():
    ...
    mountains = [   
                ...
                ('Marys Peak','https://www.yr.no/en/forecast/hourly-table/2-5739271/United%20States/Oregon/Benton/Marys%20Peak?i=1'),
                ...
                ('Rudolf Glacier','https://www.yr.no/en/forecast/hourly-table/2-2183105/New%20Zealand/Rudolf%20Glacier?i=1'),
                ('Gran Campo Nevado','https://www.yr.no/en/forecast/hourly-table/2-3888842/Chile/Region%20of%20Magallanes/Gran%20Campo%20Nevado?i=1')
            ] 
    ...
    # mysqlDB = Database.Database('mysql')  currently not working so commented out
    BuildSql = []
